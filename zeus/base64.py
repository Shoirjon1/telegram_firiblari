...
async def runb64(event):
    ...
    try:
        if options[1] == "en":
            ...
            await event.edit("Shriflash ishlari olib borilayapti...")
            sleep(2)
            ...
            await event.edit("shifrdan chiqarish ishlari olib borilayapti...")
            sleep(2)
            await event.edit(f"Shifrdan chiqarlgan xabar❯❯ {decodesecretkeybytes}")
        else:
            await event.edit("Noto'g'ri tanlov")
    except IndexError:
        await event.edit("encode yoki decode qilish kerak ekanini yozing /nMasalan ❯❯ b64 en")
    except:
        await event.edit("kechirasiz menimcha nimadir xato bo'ldi") 